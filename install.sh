...
if wget -q https://github.com/Saldarriaga184/KanakiBot-Ultra/raw/master/audio/"$random_mp3"; then
...
echo -e "\033[01;33mpkg install git -y\npkg install nodejs -y\npkg install ffmpeg -y\npkg install imagemagick -y\npkg install yarn\ngit clone https://github.com/Saldarriaga184/KanakiBot-Ultra\ncd KanakiBot-Ultra\nnpm install\nyarn install\nnpm start\033[0m"
exit 1
else
...
echo -e "\033[1;35m"
git clone https://github.com/Saldarriaga184/KanakiBot-Ultra.git
...
menu_ayuda() {
    #printf "${v1}[${b}++${v1}]${v} KanakiBot-Ultra${b}: "
	read opcion
	case $opcion in
            01|1)
...
echo -e "\033[01;32m\033[01mIniciando KanakiBot-Ultra!!\n\033[0m"
npm start